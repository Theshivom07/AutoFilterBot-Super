...
id_pattern = re.compile(r'^\d+$')  # Fix the regex pattern
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/ultroidofficial_Support')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/ultroidofficial')
